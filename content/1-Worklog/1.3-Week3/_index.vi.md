...
* Khảo sát hệ thống Todoist có sẵn và thảo luận cấu trúc hệ thống cho phần mềm sẽ xây dựng


### Các công việc cần triển khai trong tuần này:
| Thứ | Công việc| Ngày bắt đầu | Ngày hoàn thành | Nguồn tài liệu |
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------ | --------------- | ----------------------------------------- |
| 2   | - Xem video bài giảng về dịch vụ Compute VM trên AWS <br> - Dịch blogs cho tuần 3 | 22/9/2025 | 22/9/2025 | [link bài viết gốc](https://aws.amazon.com/vi/blogs/startups/accelerating-the-next-wave-of-generative-ai-startups/)
| 3   | - **Thực hành:** <br>+ lab04:  Khởi tạo và tìm hiểu các tính năng cơ bản của Amazon EC2 <br> - Khảo sát hệ thống Todoist có sẵn và bàn luận về hệ thống sẽ xây dựng | 23/9/2025 | 23/9/2025 | <https://000004.awsstudygroup.com/> |
...
| 6   | - **Thực hành:** + lab06: Triển khai ứng dụng FCJ Management với Auto Scaling Group <br> + lab13: Triển khai aws backup cho hệ thống <br> - Cập nhật worklog | 26/9/2025 | 26/9/2025| <https://000006.awsstudygroup.com/> <https://000013.awsstudygroup.com/> |
...
* Khảo sát hệ thống có sẵn và chốt được cấu trúc hệ thống:
  * Backend: Spring
  * Frontend: React
  * Database: MySQL

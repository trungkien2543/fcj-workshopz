...
Việc sử dụng DRAGEN trên các instance F, được cung cấp bởi FPGA, còn mang lại lợi thế về tiêu thụ điện năng so với các giải pháp truyền thống dựa trên CPU và GPU. FPGA vốn dĩ hiệu quả năng lượng hơn, tiêu thụ ít điện năng hơn để đạt cùng mức hiệu năng tính toán cho các workload này. Điều này đặc biệt quan trọng trong các tác vụ phân tích dữ liệu genomic, nơi khối lượng dữ liệu và thời gian xử lý có thể rất lớn.
